...
KEditor.prototype = {
	...
	beforeSetHtml : function(fn) {
		...
		//在这里处理图片,如何是在线图片，base64图片，就下载到本地
		if($("#beforeSetH").length == 1 && typeof(fn) == "string" ){
			if(fn && (fn.indexOf("img") !=- 1)){
                $("input[name='htmlStr']").val(fn);
                $.ajax({
                    url:$("#beforeSetH").attr("action"),
                    type:"post",
					async:false,//同步
                    data:$("#beforeSetH").serialize(),
        ...
        return this.handler('beforeSetHtml', funstr);
	},
